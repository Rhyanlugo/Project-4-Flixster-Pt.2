...
class TopRatedMovieRecyclerViewAdapter(
	...
	private val topRatedMovieList: List<TopRatedMovie>
) : RecyclerView.Adapter<TopRatedMovieRecyclerViewAdapter.ViewHolder>()
{
		...
		View.OnClickListener
	{
		...
		{
			val topRatedMovie = topRatedMovieList[absoluteAdapterPosition]
	...
	{
		val topRatedMovie = topRatedMovieList[position]
